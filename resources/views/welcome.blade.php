            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_service_wrap text-center">
                        <img src="/assets/img/svg_icon/controls.svg" alt="">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_service_wrap text-center">
                        <img src="/assets/img/svg_icon/bar-chart.svg" alt="">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_service_wrap text-center">
                        <img src="/assets/img/svg_icon/puzzle.svg" alt="">
                        <h3>Problem Solving</h3>
                        <p>These cases are perfectly simple and easy to </p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="finance_thumb">
                        <img src="/assets/img/about/finance.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    <div class="testmonial_active2 owl-carousel">
                        <div  class="single_slider text-center" data-dot='<img src="/assets/img/testmonial/1.png" alt="#" ' >
